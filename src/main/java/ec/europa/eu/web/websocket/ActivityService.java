package ec.europa.eu.web.websocket;

import ec.europa.eu.security.SecurityUtils;
import ec.europa.eu.web.websocket.dto.ActivityDTO;
...
import static ec.europa.eu.config.WebsocketConfiguration.IP_ADDRESS;
